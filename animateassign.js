...
if (reversed == null) { reversed = false; }
	...
	this.shape.graphics.f("#6E6E6E").s().p("AvSUkQgyABAAgyMAAAgnlQAAgxAyAAIelAAQAyAAAAAxMAAAAnlQAAAygygBg");
...
p.nominalBounds = new cjs.Rectangle(-102.9,-131.6,205.8,263.29999999999995);
...
if (reversed == null) { reversed = false; }
	...
	props.mode = mode;
	props.startPosition = startPosition;
	props.labels = {follow:135,EndSquash:1,startanti:81};
	props.loop = loop;
	props.reversed = reversed;
	cjs.MovieClip.apply(this,[props]);
	...
	this.instance.setTransform(963.6,352.95);
	this.instance._off = true;

	this.instance_1 = new lib.Tween16("synched",0);
	this.instance_1.setTransform(1052.1,444.75);
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.instance}]},135).to({state:[{t:this.instance_1}]},10).to({state:[]},35).wait(4));
	this.timeline.addTween(cjs.Tween.get(this.instance).wait(135).to({_off:false},0).to({_off:true,x:1052.1,y:444.75},10).wait(39));
	...
	this.instance_2.setTransform(524.15,543.65);
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(2).to({_off:false},0).to({rotation:-14.9983,x:201,y:502.5},7).to({rotation:-2.9993,x:333.45,y:384.2},7).to({_off:true,regY:0.2,scaleX:0.7161,scaleY:1.4435,rotation:0,x:377.55,y:357.9},2).wait(166));
	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(16).to({_off:false},2).to({regX:0.1,scaleX:0.8039,scaleY:1.3394,x:346.35,y:329.2},2).to({regY:0.1,scaleX:1.2431,scaleY:0.8186,x:189.9,y:186.1},9).to({regX:0,regY:0,scaleX:0.7978,scaleY:1.2821,x:139.8,y:239.9},5).to({scaleX:0.7879,scaleY:1.1814,x:258.6,y:329.05},9).to({scaleX:0.78,scaleY:1.1008,x:353.65,y:400.35},7).to({regX:0.1,regY:0.1,scaleX:0.6772,scaleY:1.4444,x:381.4,y:413.4},2).to({scaleX:0.9978,scaleY:0.9939,x:319.85,y:479.2},9).to({regX:0.2,regY:0.2,scaleX:0.998,x:270.6,y:531.95},7).to({regX:0.1,regY:0,scaleX:1.3845,scaleY:0.8593,x:258.35,y:545.1},4).to({regX:0.2,regY:0.2,scaleX:0.9982,scaleY:0.9942,x:258.4,y:539.4},7).wait(2).to({alpha:0},0).to({_off:true},99).wait(4));

	// SquashStretch
	this.instance_5 = new lib.Symbol2("synched",0);
	this.instance_5.setTransform(257.5,101.85,0.7962,1,0,0,0,52.6,52.5);
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(2).to({_off:false},0).to({regY:52.6,scaleY:0.5581,y:549.15},6).to({regX:52.8,regY:52.7,scaleY:0.9664,x:257.65,y:459.9},2).to({regX:52.6,regY:52.5,scaleY:1,x:257.5,y:390.15},2).to({scaleY:0.7276,y:540.2},4).to({regY:52.6,scaleY:0.8471,y:475.05},2).to({y:534},2).to({_off:true},160).wait(4));
